...
FORBIDDEN_FIELD_NAMES = frozenset(
    {
        ...
        "regulatory_request",
        "regulatory_result",
        "regulatory_intelligence_request",
        "regulatory_intelligence_result",
        "attempt_number",
        "selected_fact",
        "facts",
        "failure_facts",
