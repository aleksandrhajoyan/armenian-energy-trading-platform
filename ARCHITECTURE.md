...
→ attempt-number source contract
→ concrete attempt source still missing
→ failure-context resolution service
→ FailurePolicyContext
→ prepared decision/action handling
→ LangGraph routing still missing
