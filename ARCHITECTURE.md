...
Broader ML/agent import rules remain for later chunks. Chunk 118 now locks the first Consumer Load Forecast application↔ML port: `application model port ← future ml adapter`.
