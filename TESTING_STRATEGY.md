...
Each agent tested with port fakes. Assert canonical in/out. Two concrete agents exist: Weather & Renewable Forecast Agent and Hydro Resources Agent; remaining agents stay fake-driven until implemented. Especially: Consumer Load Forecast Agent and DAM Price Forecast Agent call forecasting **ports**, **not** an LLM port and **not** concrete ML libraries, for numeric outputs.
