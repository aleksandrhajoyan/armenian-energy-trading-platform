...
Each agent tested with port fakes. Assert canonical in/out. Four concrete agents exist: Weather & Renewable Forecast Agent, Hydro Resources Agent, Generation Availability Agent, and News Intelligence Agent; remaining agents stay fake-driven until implemented. Especially: Consumer Load Forecast Agent and DAM Price Forecast Agent call forecasting **ports**, **not** an LLM port and **not** concrete ML libraries, for numeric outputs.
