"""Application-owned Phase 3 failure-policy decision boundary.
...
* Application: owns ``ForecastingFailureDecisionService``.
...
class ForecastingFailureDecisionService:
    """Phase-3-specific failure-policy decision composition.
