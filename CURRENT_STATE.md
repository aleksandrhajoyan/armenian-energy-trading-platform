...
Everything after Chunk 34 in `ROADMAP.md`. Next is **next Phase 4 implementation slice to be selected after Chunk 34 review**. Phase 4 has begun; it is not complete. Five concrete application agents exist and all remain provider-neutral and unwired. Orchestration still invokes no agents. Do not claim the trading workflow runs end-to-end. Do not install embedding SDKs or ML stacks until those chunks.
