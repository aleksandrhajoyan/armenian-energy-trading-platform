...
- Time-series validation architecture tests (no application/API/ML/file-reader leakage; ports have no interval-grid surface)
...
Everything after Chunk 9 in `ROADMAP.md`. Highest priority: Chunk 10 — Missing-Interval Detection and Gap Reporting. Do not install LangGraph, databases, ML stacks, or Docker services until those chunks.
