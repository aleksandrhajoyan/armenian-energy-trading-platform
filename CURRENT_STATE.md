...
- Attempt tracking for Phase 2 failure-policy context
...
- Parallel-ingestion plan/success/execution-port/executor/context-port/workflow-step/success-transition/failure-transition/failure-decision/failure-context/failure-action/failure-handling/agent-failure/exception-group-extraction/failure-fact-classification/tuple-failure-classification/failure-fact-selection unit and architecture tests (real request/result DTOs; real agents behind source fakes; structural context/execution/policy/selection fakes; no live services)
