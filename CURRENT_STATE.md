...
→ attempt-number source contract exists, concrete attempt tracking/source implementation still missing
→ FailurePolicyContext
→ prepared decision/action handling
→ LangGraph runtime routing still missing
```
